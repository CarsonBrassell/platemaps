...
export function PostMediaCarousel({
  ...
  if (media.length === 0) {
    return (
      <div className="aspect-[3/4] w-full select-none">
  ...
  return (
    <div className="group/media relative">
      <div
        ...
        /* 3:4, the shape every photo is captured at — see `SHOT_W`/`SHOT_H`
        ...
        className={`snap-track flex aspect-[3/4] w-full overflow-x-auto ${
