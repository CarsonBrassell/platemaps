...
export function PointsBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 whitespace-nowrap rounded-full bg-pm-orange-tint/70 px-1.5 py-0.5 font-medium text-pm-orange-text ring-1 ring-inset ring-pm-orange-border/60 ${
