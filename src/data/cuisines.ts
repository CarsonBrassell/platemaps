...
const ALIASES: Readonly<Record<string, Cuisine>> = {
  ...
  /* --- Google Maps place types (discover-serper.mjs, 2026-09-05) --------
     Google types a place with a snake_case category; key() turns the
     underscores into spaces. Anything ending in "restaurant" that names a
     cuisine lands in that cuisine; the generic service types (takeout,
     delivery, family, fine dining) say nothing about the food and sit in
     UNSET below, where infer-cuisine.mjs picks them up from the menu. */
  "bar and grill": "Bars",
  "bar grill": "Bars",
  "hookah bar": "Bars",
  winery: "Bars",
  ...
  "cider bar": "Bars",
  "irish pub": "Bars",
  "chocolate shop": "Bakery & Desserts",
  "candy store": "Bakery & Desserts",
  creperie: "Bakery & Desserts",
  "health food restaurant": "Vegetarian",
  "organic restaurant": "Vegetarian",
  "gluten free restaurant": "Vegetarian",
  "coffee stand": "Coffee & Tea",
  "korean barbecue restaurant": "Korean",
  "poke bar": "Hawaiian",
  "pacific rim restaurant": "Hawaiian",
  guamanian: "Hawaiian",
  "pizza delivery": "Pizza",
  "pizza takeout": "Pizza",
  "sicilian restaurant": "Italian",
  "chinese noodle restaurant": "Chinese",
  "chinese takeaway": "Chinese",
  "wok restaurant": "Chinese",
  "mongolian barbecue restaurant": "Chinese",
  "sushi takeaway": "Japanese",
  "conveyor belt sushi restaurant": "Japanese",
  "authentic japanese restaurant": "Japanese",
  "japanese steakhouse": "Japanese",
  "udon noodle restaurant": "Japanese",
  "seafood donburi restaurant": "Japanese",
  "shabu shabu restaurant": "Japanese",
  "pan asian restaurant": "Asian",
  "south indian restaurant": "Indian",
  "halal restaurant": "Mediterranean",
  "fish and seafood restaurant": "Seafood",
  "oyster bar restaurant": "Seafood",
  "mexican torta restaurant": "Mexican",
  "oaxacan restaurant": "Mexican",
  "pozole restaurant": "Mexican",
  "jamaican restaurant": "Latin American",
  "guatemalan restaurant": "Latin American",
  "central american restaurant": "Latin American",
  "modern european restaurant": "American",
  "traditional american restaurant": "American",
  "hungarian restaurant": "American",
  "belgian restaurant": "American",
  "swedish restaurant": "American",
  "danish restaurant": "American",
...
const SYNONYMS: Readonly<Record<string, readonly string[]>> = {
  ...
  "tex-mex": ["Tacos"],
  japanese: ["Sushi"],
  "coffee shop": ["Coffee", "Cafe", "Breakfast"],
  ...
  /* Breakfast is a meal, not a cuisine — coffee, juice/açaí, bagels, donuts
     and bakeries are the kinds of place a visitor means by "a breakfast
     spot", even though none of them are filed under the Breakfast & Brunch
     cuisine. Calvin's call, 2026-09-13, after Everbowl (Juice & Smoothies)
     and the SDSU coffee shops (Coffee & Tea) didn't turn up for "breakfast". */
  "coffee stand": ["Breakfast"],
  "coffee & tea": ["Breakfast"],
  "juice shop": ["Breakfast"],
  juice: ["Breakfast"],
  "juice bar": ["Breakfast"],
  smoothie: ["Breakfast"],
  smoothies: ["Breakfast"],
  ...
  creperie: ["Breakfast", "Brunch", "Crepes"],
  crepe: ["Breakfast", "Brunch", "Crepes"],
