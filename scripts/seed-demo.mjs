...
const POSTS = [
  ...
  },
  {
    user: "sam",
    dish: "Tres leches",
    restaurant: "Chula Vista Cantina",
    text: "Came for tacos, stayed for this. Soaked all the way through, not soggy. Split it and still wanted my own.",
    price: "$8",
    rating: 8.9,
    location: "6.2 miles away",
    tags: ["Dessert", "Late Night", "Under $15"],
    photos: ["1559847844-5315695dadae"],
    hours: 40,
    likes: ["priya", "diego"],
    comments: [{ user: "priya", text: "Dessert at a taqueria is always the move" }],
  },
  {
    user: "maya",
    dish: "Fish and chips, dockside",
    restaurant: "Point Loma Seafood Co.",
