# Dish review — 2026-09-13

26 posts naming a plate across 19 restaurants.

- **menu-typo** — 0 · Misspellings of a dish already on the menu
- **new-dish** — 0 · New dish — two or more people named it
- **new-dish-photo** — 12 · New dish — one person, with a photo
- **held** — 2 · Held — one person, no photo
- 10 spellings already matched a menu dish exactly (not shown).
...
```
node --env-file=.env.local scripts/apply-dish-review.mjs probe/dish-review-2026-09-13.md
```
...
## New dish — one person, with a photo (12)

<!-- item n=1 r=3824 bucket=new-dish-photo folds=steak -->
### 1. Steak — Aztec Food Hub
...
<!-- item n=2 r=13 bucket=new-dish-photo folds=cortado and a morning bun -->
### 2. Cortado and a morning bun — Breakfast Republic
...
<!-- item n=3 r=8708 bucket=new-dish-photo folds=shrimp and grits -->
### 3. Shrimp and grits — Breakfast Republic
...
> **“Shrimp and grits”** · calvin lensink  · 2026-09-12 · 82.0% · [photo](https://70xwh4kizzssi7so.public.blob.vercel-storage.com/posts/940561ca-05c8-4010-b8a9-f397235378b9/10dbec33-51a8-4e99-846a-628fbfd63b1d.jpg)  
> Yummy
